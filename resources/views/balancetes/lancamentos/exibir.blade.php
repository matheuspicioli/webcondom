							...
							<div class="row">
								<div class="col-md-2 col-md-offset-1">
									<div class="form-group">
										...
										<input type="date" name="data_lancamento" id="data_lancamento" class="form-control" tabindex="1"
								...
								<div class="col-md-1">
									<div class="form-group">
										...
										tabindex="2" value="{{ old('folha') ? old('folha') : $lancamento->folha }}">
										@if( $errors->has('folha') )
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" id="documento" name="documento" class="form-control pula" @if($errors->has('documento')) style="border:1px solid #f56954" @endif
											tabindex="3" value="{{ old('documento') ? old('documento') : $lancamento->documento }}">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										tabindex="4" value="{{ old('valor') ? old('valor') : $lancamento->valor }}">
										@if( $errors->has('valor') )
								...
								<div class="col-md-2">
									<div class="form-group" @if($errors->has('tipo')) style="color: #f56954" @endif>
										...
										<select name="tipo" id="tipo" class="form-control select2" tabindex="4">
							...
							<div class="row">
								<div class="col-md-4 col-md-offset-1">
									<div class="form-group">
										...
										<select name="plano_contas_id" id="plano_contas_id" class="form-control select2" tabindex="5">
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<select name="fornecedor_id" id="fornecedor_id" class="form-control select2" tabindex="6">
											<option selected disabled>===============SELECIONE===============</option>
							...
							<div class="row">
								<div class="col-md-9 col-md-offset-1">
									<div class="form-group">
										...
										value="{{ old('historico') ? old('historico') : $lancamento->historico }}" tabindex="7">

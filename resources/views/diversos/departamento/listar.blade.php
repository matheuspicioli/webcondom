                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can("exibir_departamento")
                                            <a class="btn btn-sm btn-warning" href="{{ route('diversos.departamento.exibir', ['id' => $departamento->id ]) }}">
                                        ...
                                        @can("deletar_departamento")
                                            <button type="button" data-toggle="modal" data-target="#modal-danger-{{$departamento->id}}" href="#" class="btn btn-sm btn-danger">

...
@section('title', 'Departamentos - Lista')
        ...
        <div class="row">
            <div class="col-md-1">
                @can("incluir_departamento")
                    <a href="{{ route('diversos.departamento.criar') }}" class="btn btn-success">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can("exibir_departamento")
                                            <a class="btn btn-xs btn-warning" href="{{ route('diversos.departamento.exibir', ['id' => $departamento->id ]) }}">
                                        ...
                                        @can("deletar_departamento")
                                            <button type="button" data-toggle="modal" data-target="#modal-danger-{{$departamento->id}}" href="#" class="btn btn-xs btn-danger">

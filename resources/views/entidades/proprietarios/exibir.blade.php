                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" class="form-control pula"
                                               ...
                                               value="{{ old('codigo') ? old('codigo') : $proprietario->codigo }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telefone_principal" id="telefone_principal"
                                               ...
                                               value="{{ old('telefone_principal') ? old('telefone_principal') : $proprietario->entidade->telefone_principal }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        id="telefone_comercial" class="form-control pula"
                                               value="{{ old('telefone_comercial') ? old('telefone_comercial') : $proprietario->entidade->telefone_comercial }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="celular_1" id="celular_1" @if($errors->has('celular_1')) style="border:1px solid #f56954" @endif class="form-control pula"
                                               value="{{ old('celular_1') ? old('celular_1') : $proprietario->entidade->celular_1 }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="celular_2" id="celular_2"
                                               ...
                                               value="{{ old('celular_2') ? old('celular_2') : $proprietario->entidade->celular_2 }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="CEP" type="text" class="form-control pula" name="cep_principal"
                                                               value="{{ old('cep_principal') ? old('cep_principal') : $proprietario->entidade->endereco_principal->cep }}"

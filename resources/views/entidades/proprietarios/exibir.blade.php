                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="tipo" id="tipo" class="form-control pula">
                                            ...
                                            <option value="CPF" {{ old('tipo') == 'CPF' ? 'selected' : ($proprietario->entidade->tipo == 'CPF' ? 'selected' : '') }}>
                                                CPF
                                            </option>
                                            <option value="CNPJ" {{ old('tipo') == 'CNPJ' ? 'selected' : ($proprietario->entidade->tipo == 'CNPJ' ? 'selected' : '') }}>
                                                CNPJ
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control pula"
                                               ...
                                               value="{{ old('cpf_cnpj') ? old('cpf_cnpj') : $proprietario->entidade->cpf_cnpj }}">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome" id="nome" class="form-control pula"
                                               ...
                                               value="{{ old('nome') ? old('nome') : $proprietario->entidade->nome }}">
                                        @if( $errors->has('nome') )
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apelido" id="apelido" class="form-control pula"
                                               ...
                                               value="{{ old('apelido') ? old('apelido') : $proprietario->entidade->apelido }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="rg_ie" id="rg_ie" class="form-control pula"
                                               ...
                                               value="{{ old('rg_ie') ? old('rg_ie') : $proprietario->entidade->rg_ie }}">
                                        @if( $errors->has('rg_ie') )
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" class="form-control pula"
                                               ...
                                               data-mask="999999" value="{{ old('codigo') ? old('codigo') : $proprietario->codigo }}">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fantasia" id="fantasia" class="form-control cnpj pula"
                                               ...
                                               value="{{ old('fantasia') ? old('fantasia') : $proprietario->entidade->fantasia }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inscricao_municipal" id="inscricao_municipal"
                                               ...
                                               value="{{ old('inscricao_municipal') ? old('inscricao_municipal') : $proprietario->entidade->inscricao_municipal }}">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ramo_atividade" id="ramo_atividade"
                                               ...
                                               value="{{ old('ramo_atividade') ? old('ramo_atividade') : $proprietario->entidade->ramo_atividade }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_abertura" id="data_abertura"
                                               ...
                                               value="{{ old('data_abertura') ? old('data_abertura') : ($proprietario->entidade->data_abertura ? $proprietario->entidade->data_abertura->format('Y-m-d') : '') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome_mae" id="nome_mae" class="form-control cpf pula"
                                               ...
                                               value="{{ old('nome_mae') ? old('nome_mae') : $proprietario->entidade->nome_mae }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="estado_civil_id" id="estado_civil_id"
                                            ...
                                            @foreach($estados_civis as $estados_civil)
                                                <option value="{{ $estados_civil->id }}" {{ old('estado_civil_id') == $estados_civil->id ? 'selected' : ($proprietario->entidade->estado_civil_id == $estados_civil->id ? 'selected' : '') }}>
                                        ...
                                        class="form-control cpf pula">
                                            ...
                                            @foreach($regimes_casamentos as $regime_casamento)
                                                <option value="{{ $regime_casamento->id }}"
                                                        {{ old('regime_casamento_id') == $regime_casamento->id ? 'selected' : ($proprietario->entidade->regime_casamento_id == $regime_casamento->id ? 'selected' : '') }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="profissao" id="profissao" class="form-control cpf pula"
                                               ...
                                               value="{{ old('profissao') ? old('profissao') : $proprietario->entidade->profissao }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_nascimento" id="data_nascimento" class="form-control cpf pula"
                                               ...
                                               value="{{ old('data_nascimento') ? old('data_nascimento') : ($proprietario->entidade->data_nascimento ? $proprietario->entidade->data_nascimento->format('Y-m-d') : '') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nacionalidade" id="nacionalidade"
                                               ...
                                               value="{{ old('nacionalidade') ? old('nacionalidade') : $proprietario->entidade->nacionalidade }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="empresa" id="empresa"
                                               ...
                                               value="{{ old('empresa') ? old('empresa') : $proprietario->entidade->empresa }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inss" id="inss" class="form-control cpf pula"
                                               ...
                                               value="{{ old('inss') ? old('inss') : $proprietario->entidade->inss }}">
                                        @if( $errors->has('inss') )
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="dependentes" id="dependentes" class="form-control cpf pula"
                                               ...
                                               value="{{ old('dependentes') ? old('dependentes') : $proprietario->entidade->dependentes }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telefone_principal" id="telefone_principal"
                                               ...
                                               data-mask="(99) 9999-9999" value="{{ old('telefone_principal') ? old('telefone_principal') : $proprietario->entidade->telefone_principal }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        id="telefone_comercial" class="form-control pula"
                                               data-mask="(99) 9999-9999" value="{{ old('telefone_comercial') ? old('telefone_comercial') : $proprietario->entidade->telefone_comercial }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="celular_1" id="celular_1" @if($errors->has('celular_1')) style="border:1px solid #f56954" @endif class="form-control pula"
                                               data-mask="(99) 99999-9999" value="{{ old('celular_1') ? old('celular_1') : $proprietario->entidade->celular_1 }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="celular_2" id="celular_2"
                                               ...
                                               data-mask="(99) 99999-9999" value="{{ old('celular_2') ? old('celular_2') : $proprietario->entidade->celular_2 }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="site" id="site" @if($errors->has('site')) style="border:1px solid #f56954" @endif class="form-control pula"
                                               value="{{ old('site') ? old('site') : $proprietario->entidade->site }}">
                                        @if( $errors->has('site') )
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email" @if($errors->has('email')) style="border:1px solid #f56954" @endif
                                            class="form-control pula" value="{{ old('email') ? old('email') : $proprietario->entidade->email }}">
                                        @if( $errors->has('email') )
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cep_principal" type="text" class="form-control pula" name="cep_principal"
                                                               data-mask="99999-999" value="{{ old('cep_principal') ? old('cep_principal') : $proprietario->entidade->endereco_principal->cep }}"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="logradouro_principal" type="text" class="form-control pula"
                                                               ...
                                                               value="{{ old('logradouro_principal') ? old('logradouro_principal') : $proprietario->entidade->endereco_principal->logradouro }}"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="numero_principal" type="text" class="form-control pula"
                                                               ...
                                                               value="{{ old('numero_principal') ? old('numero_principal') : $proprietario->entidade->endereco_principal->numero }}"
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="complemento_principal" type="text" class="form-control pula"
                                                               ...
                                                               value="{{ old('complemento_principal') ? old('complemento_principal') : ($proprietario->entidade->endereco_principal->complemento ? $proprietario->entidade->endereco_principal->complemento : '') }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bairro_principal" type="text" class="form-control pula"
                                                               ...
                                                               value="{{ old('bairro_principal') ? old('bairro_principal') : $proprietario->entidade->endereco_principal->bairro }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="cidade_id_principal" id="cidade_id_principal"
                                                            ...
                                                            @foreach($cidades as $cidade)
                                                                <option value="{{ $cidade->id }}" {{ old('cidade_id_principal') == $cidade->id ? 'selected' : ($cidade->id == $proprietario->entidade->endereco_principal->cidade_id ? 'selected' : '') }}>
                                                                    {{ $cidade->descricao }}

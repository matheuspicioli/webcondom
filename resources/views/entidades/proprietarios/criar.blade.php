        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ route('entidades.proprietarios.salvar') }}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="CEP" type="text" class="form-control pula" name="cep_principal"
                                                               value="{{ old('cep_principal') ? old('cep_principal') : '' }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Numero" type="text" class="form-control pula" name="numero_principal"
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Complemento" type="text" class="form-control pula" name="complemento_principal"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Bairro" type="text" class="form-control pula" name="bairro_principal"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="cidade_id_principal" id="CidadeCOD" class="form-control pula select2"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="CEP" type="text" class="form-control pula" name="cep_cobranca"
                                                               value="{{ old('cep_cobranca') ? old('cep_cobranca') : '' }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Numero" type="text" class="form-control pula" name="numero_cobranca"
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Complemento" type="text" class="form-control pula" name="complemento_cobranca"

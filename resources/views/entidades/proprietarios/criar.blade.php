...
@section('title', 'Proprietários - Criar')
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cep_principal" type="text" class="form-control pula" name="cep_principal"
                                                               data-mask="99999-999" value="{{ old('cep_principal') ? old('cep_principal') : '' }}"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="logradouro_principal" type="text" class="form-control pula" name="logradouro_principal"
                                                               value="{{ old('logradouro_principal') ? old('logradouro_principal') : '' }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="numero_principal" type="text" class="form-control pula" name="numero_principal"
                                                               value="{{ old('numero_principal') ? old('numero_principal') : '' }}"
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="complemento_principal" type="text" class="form-control pula" name="complemento_principal"
                                                               value="{{ old('complemento_principal') ? old('complemento_principal') : '' }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bairro_principal" type="text" class="form-control pula" name="bairro_principal"
                                                               value="{{ old('bairro_principal') ? old('bairro_principal') : '' }}"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="cidade_id_principal" id="cidade_id_principal" class="form-control pula select2"
                                                                @if($errors->has('cidade_id_principal')) style="border:1px solid #f56954" @endif>
                                                            <option selected disabled>-------Selecione uma cidade------</option>
                                                            @foreach($cidades as $cidade)
                                                                <option value="{{ $cidade->id }}" {{ old('cidade_id_principal') == $cidade->id ? 'selected' : '' }}>
                                    ...
                                    <div class="box box-warning box-solid">
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label for="logradouro_cobranca" class="control-label"
                                                               @if($errors->has('logradouro_cobranca')) style="color: #f56954" @endif>Logradouro</label>
                                                        <input id="logradouro_cobranca" type="text" class="form-control pula" name="logradouro_cobranca"
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="numero_cobranca" type="text" class="form-control pula" name="numero_cobranca"
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="complemento_cobranca" type="text" class="form-control pula" name="complemento_cobranca"

...
@section('title', 'Funcionários - Exibir/Alterar')
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="tipo" id="tipo" class="form-control pula">
											...
											<option value="CPF" {{ old('tipo') == 'CPF' ? 'selected' : ($funcionario->entidade->tipo == 'CPF' ? 'selected' : '') }}>
												CPF
											</option>
										...
										<select name="setor_id" id="setor" class="form-control pula"
											...
											@foreach($setores as $setor)
												<option value="{{ $setor->id }}" {{ old('setor_id') ? old('setor_id')
                                                 	: $setor->id == $funcionario->setor_id ? 'selected' : '' }}>
													{{ $setor->descricao }}
												</option>
											@endforeach
										</select>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<input type="text" name="nome" id="nome" class="form-control pula"
											   ...
											   value="{{ old('nome') ? old('nome') : $funcionario->entidade->nome }}">
										@if( $errors->has('nome') )
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="apelido" id="apelido" class="form-control pula"
											   ...
											   value="{{ old('apelido') ? old('apelido') : $funcionario->entidade->apelido }}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="rg_ie" id="rg_ie" class="form-control pula"
											   ...
											   value="{{ old('rg_ie') ? old('rg_ie') : $funcionario->entidade->rg_ie }}">
										@if( $errors->has('rg_ie') )
								...
								<div class="col-md-1">
									<div class="form-group">
										...
										<input type="text" name="codigo" id="codigo" class="form-control pula"
											   ...
											   data-mask="999999" value="{{ old('codigo') ? old('codigo') : $funcionario->codigo }}">
								...
								<div class="col-md-8">
									<div class="form-group">
										...
										<input type="text" name="fantasia" id="fantasia" class="form-control cnpj pula"
											   ...
											   value="{{ old('fantasia') ? old('fantasia') : $funcionario->entidade->fantasia }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="inscricao_municipal" id="inscricao_municipal"
											   ...
											   @endif
											   value="{{ old('inscricao_municipal') ? old('inscricao_municipal') : $funcionario->entidade->inscricao_municipal }}">
								...
								<div class="col-md-8">
									<div class="form-group">
										...
										<input type="text" name="ramo_atividade" id="ramo_atividade"
											   ...
											   @endif
											   value="{{ old('ramo_atividade') ? old('ramo_atividade') : $funcionario->entidade->ramo_atividade }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="date" name="data_abertura" id="data_abertura"
											   ...
											   value="{{ old('data_abertura') ? old('data_abertura') : ($funcionario->entidade->data_abertura ? $funcionario->entidade->data_abertura->format('Y-m-d') : '') }}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="nome_mae" id="nome_mae" class="form-control cpf pula"
											   ...
											   value="{{ old('nome_mae') ? old('nome_mae') : $funcionario->entidade->nome_mae }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="profissao" id="profissao" class="form-control cpf pula"
											   ...
											   value="{{ old('profissao') ? old('profissao') : $funcionario->entidade->profissao }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="date" name="data_nascimento" id="data_nascimento"
											   class="form-control cpf pula" @if($errors->has('data_nascimento')) style="border:1px solid #f56954" @endif
											   value="{{ old('data_nascimento') ? old('data_nascimento') : ($funcionario->entidade->data_nascimento ? $funcionario->entidade->data_nascimento->format('Y-m-d') : '') }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="nacionalidade" id="nacionalidade"
											   ...
											   value="{{ old('nacionalidade') ? old('nacionalidade') : $funcionario->entidade->nacionalidade }}">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="empresa" id="empresa" class="form-control cpf pula" @if($errors->has('empresa')) style="border:1px solid #f56954" @endif
											   value="{{ old('empresa') ? old('empresa') : $funcionario->entidade->empresa }}">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="inss" id="inss" class="form-control cpf pula"
											   ...
											   value="{{ old('inss') ? old('inss') : $funcionario->entidade->inss }}">
										@if( $errors->has('inss') )
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="number" name="dependentes" id="dependentes"
											   ...
											   value="{{ old('dependentes') ? old('dependentes') : $funcionario->entidade->dependentes }}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="telefone_principal" id="telefone_principal" class="form-control pula"
											   @if($errors->has('telefone_principal')) style="border:1px solid #f56954" @endif
											   data-mask="(99) 9999-9999" value="{{ old('telefone_principal') ? old('telefone_principal') : ($funcionario->entidade->telefone_principal ? $funcionario->entidade->telefone_principal : '')}}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="telefone_comercial"
											   @if($errors->has('telefone_comercial')) style="border:1px solid #f56954" @endif id="telefone_comercial" class="form-control pula"
											   data-mask="(99) 9999-9999" value="{{ old('telefone_comercial') ? old('telefone_comercial') : ($funcionario->entidade->telefone_comercial ? $funcionario->entidade->telefone_comercial : '') }}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="celular_1" id="celular_1"
											   @if($errors->has('celular_1')) style="border:1px solid #f56954" @endif class="form-control pula"
											   data-mask="(99) 99999-9999" value="{{ old('celular_1') ? old('celular_1') : $funcionario->entidade->celular_1 }}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="celular_2" id="celular_2"
											   ...
											   data-mask="(99) 99999-9999" value="{{ old('celular_2') ? old('celular_2') : ($funcionario->entidade->celular_2 ? $funcionario->entidade->celular_2 : '') }}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="site" id="site"
											   @if($errors->has('site')) style="border:1px solid #f56954" @endif class="form-control pula"
											   value="{{ old('site') ? old('site') : ($funcionario->entidade->site ? $funcionario->entidade->site : '') }}">
										@if( $errors->has('site') )
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="email" name="email" id="email"
											   @if($errors->has('email')) style="border:1px solid #f56954" @endif class="form-control pula"
											   value="{{ old('email') ? old('email') : $funcionario->entidade->email }}">
										@if( $errors->has('email') )
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input id="CEP" type="text" class="form-control pula" name="cep"
															   data-mask="99999-999" value="{{ old('cep') ? old('cep') : $funcionario->entidade->endereco_principal->cep }}"
												...
												<div class="col-md-8">
													<div class="form-group">
														...
														<input id="Logradouro" type="text" class="form-control pula"
															   name="logradouro"
															   value="{{ old('logradouro') ? old('logradouro') : $funcionario->entidade->endereco_principal->logradouro }}"
												...
												<div class="col-md-2">
													<div class="form-group">
														...
														<input id="Numero" type="text" class="form-control pula"
															   name="numero"
															   value="{{ old('numero') ? old('numero') : $funcionario->entidade->endereco_principal->numero }}"
												...
												<div class="col-md-10">
													<div class="form-group">
														...
														<input id="Complemento" type="text" class="form-control pula"
															   name="complemento"
															   value="{{ old('complemento') ? old('complemento') : ($funcionario->entidade->endereco_principal->complemento ? $funcionario->entidade->endereco_principal->complemento : '') }}"
													...
													<div class="form-group">
														...
														<select name="cidade_id" id="CidadeCOD"
															...
															@foreach($cidades as $cidade)
																<option value="{{ $cidade->id }}" {{ old('cidade_id') == $cidade->id ? 'selected' : ($cidade->id == $funcionario->entidade->endereco_principal->cidade_id ? 'selected' : '') }}>
																	{{ $cidade->descricao }}

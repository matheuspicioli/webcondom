                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_abertura" id="data_abertura"
                                               class="form-control cnpj pula" value="{{ $funcionario->entidade->data_abertura ? $funcionario->entidade->data_abertura->format('Y-m-d') : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_nascimento" id="data_nascimento"
                                            class="form-control cpf pula" value="{{ $funcionario->entidade->data_nascimento ? $funcionario->entidade->data_nascimento->format('Y-m-d') : '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">

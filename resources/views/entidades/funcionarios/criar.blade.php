@extends('layouts.app')
@section('titulo', 'Funcionários - Criar')
@section('conteudo')
    <pagina tamanho="10">
        <painel cor="panel-primary" titulo="Cadastrar funcionário">
            <div class="row">
                <div class="col-md-1">
                    <a href="{{ route('entidades.funcionarios.listar') }}" class="btn btn-default">Voltar</a>
                    <hr>
                </div>
                <div class="col-md-11">
            ...
            <formulario method="POST" action="{{ route('entidades.funcionarios.salvar') }}" token="{{ csrf_token() }}">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nacionalidade" id="nacionalidade" class="form-control cpf" value="BRASILEIRO">
                        </div>
                    </div>
                </div>
                <div class="row">

...
@section('title', 'Funcionários - Lista')
@section('content_header')
    <h1>Funcionários - <small>listagem</small></h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a>
        </li>
        <li class="active">
            <i class="fa fa-home"></i> Funcionários
        </li>
    </ol>
@stop
        ...
        <div class="row">
            <div class="col-md-1">
                @can("incluir_funcionario")
                    <a href="{{ route('entidades.funcionarios.criar') }}" class="btn btn-success">

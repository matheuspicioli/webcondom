                        ...
                        <table class="table table-striped table-hover dataTable" id="tabela" role="grid">
                            ...
                            @foreach($empresas as $empresa)
                                <tr>
                                    ...
                                    <td>
                                        @can("exibir_empresa")
                                            <a class="btn btn-xs btn-warning" href="{{ route('entidades.empresas.exibir', ['id' => $empresa->id ]) }}">
                                        ...
                                        @can("deletar_empresa")
                                            <button type="button" data-toggle="modal" data-target="#modal-danger-{{$empresa->id}}" href="#" class="btn btn-xs btn-danger">

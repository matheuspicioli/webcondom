					...
					<div class="box-body">
						<form action="{{ route('entidades.fornecedores.salvar') }}" method="POST">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="tipo_fornecedor" class="control-label"
											   @if($errors->has('tipo_fornecedor')) style="color: #f56954" @endif>Tipo</label>
										<select name="tipo_fornecedor" id="tipo_fornecedor" class="form-control pula"
												@if($errors->has('tipo_fornecedor')) style="border:1px solid #f56954" @endif>
											<option value="-1" selected disabled>-----SELECIONE-----</option>
											<option value="PECAS"
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select name="estado_civil_id" id="estado_civil_id"
												...
												@if($errors->has('estado_civil_id')) style="border:1px solid #f56954" @endif>
											<option value="-1" selected disabled>-----SELECIONE-----</option>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select name="regime_casamento_id" id="regime_casamento_id"
												class="form-control cpf pula"
												@if($errors->has('regime_casamento_id')) style="border:1px solid #f56954" @endif>
											<option value="-1" selected disabled>-----SELECIONE-----</option>
											@foreach($regimes_casamentos as $regime_casamento)
												<option value="{{ $regime_casamento->id }}" {{ old('regime_casamento_id') == $regime_casamento->id ? 'selected' : '' }}>
													{{ $regime_casamento->descricao }}
												</option>
											@endforeach
										</select>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input id="Bairro" type="text" class="form-control pula"
															   name="bairro" value="{{ old('complemento') }}"

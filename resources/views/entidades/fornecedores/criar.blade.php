@extends('layouts.app')
@section('titulo', 'Fornecedores - Criar')
@section('conteudo')
    <pagina tamanho="10">
        <painel cor="panel-primary" titulo="Cadastrar fornecedor">
            <div class="row">
                <div class="col-md-1">
            ...
            <formulario method="POST" action="{{ route('entidades.fornecedores.salvar') }}" token="{{ csrf_token() }}">
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="inscricao_municipal" id="inscricao_municipal" class="form-control cnpj pula">
                        </div>
                    </div>
                </div>
                <div class="row">

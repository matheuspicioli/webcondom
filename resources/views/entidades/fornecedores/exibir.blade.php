        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ route('entidades.fornecedores.alterar', ['id' => $fornecedor->id ]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_abertura" id="data_abertura"
                                               class="form-control cnpj pula" value="{{ $fornecedor->entidade->data_abertura ? $fornecedor->entidade->data_abertura->format('Y-m-d') : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">

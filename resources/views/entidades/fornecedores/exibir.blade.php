...
@section('conteudo')
    <pagina tamanho="10">
        <painel cor="panel-primary" titulo="Alterar fornecedor">
            ...
            <formulario method="PUT" action="{{ route('entidades.fornecedores.alterar', ['id' => $fornecedor->id]) }}"
                        token="{{ csrf_token() }}">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="tipo" id="tipo" class="form-control pula">
                                ...
                                <option value="CPF" {{ $fornecedor->entidade->tipo == 'CPF' ? 'selected' : '' }}>CPF
                                </option>
                                <option value="CNPJ" {{ $fornecedor->entidade->tipo == 'CNPJ' ? 'selected' : '' }}>
                                    CNPJ
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="tipo_fornecedor" id="tipo_fornecedor" class="form-control pula">
                                <option value="-1" selected disabled>-----SELECIONE-----</option>
                                <option value="PECAS" {{ $fornecedor->tipo_fornecedor == 'PECAS' ? 'selected' : '' }}>
                                    PECAS
                                </option>
                                <option value="SERVICOS" {{ $fornecedor->tipo_fornecedor == 'SERVICOS' ? 'selected' : '' }}>
                                    SERVICOS
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control pula"
                                   value="{{ $fornecedor->entidade->cpf_cnpj }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control pula"
                                   value="{{ $fornecedor->entidade->nome }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="apelido" id="apelido" class="form-control pula"
                                   value="{{ $fornecedor->entidade->apelido }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="rg_ie" id="rg_ie" class="form-control pula"
                                   value="{{ $fornecedor->entidade->rg_ie }}">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="fantasia" id="fantasia" class="form-control cnpj pula"
                                   value="{{ $fornecedor->entidade->fantasia }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="inscricao_municipal" id="inscricao_municipal"
                                   class="form-control cnpj pula" value="{{ $fornecedor->entidade->inscricao_municipal }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="ramo_atividade" id="ramo_atividade"
                                   class="form-control cnpj pula" value="{{ $fornecedor->entidade->ramo_atividade }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_abertura" id="data_abertura"
                                   class="form-control cnpj pula" value="{{ $fornecedor->entidade->data_abertura }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_mae" id="nome_mae" class="form-control cpf pula"
                                   value="{{ $fornecedor->entidade->nome_mae }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="profissao" id="profissao" class="form-control cpf pula"
                                   value="{{ $fornecedor->entidade->profissao }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_nascimento" id="data_nascimento"
                                   class="form-control cpf pula" value="{{ $fornecedor->entidade->data_nascimento }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nacionalidade" id="nacionalidade"
                                   class="form-control cpf pula" value="{{ $fornecedor->entidade->nacionalidade }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="empresa" id="empresa"
                                   class="form-control cpf pula" value="{{ $fornecedor->entidade->empresa }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="inss" id="inss" class="form-control cpf pula"
                                   value="{{ $fornecedor->entidade->inss }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="dependentes" id="dependentes"
                                   class="form-control cpf pula" value="{{ $fornecedor->entidade->dependentes }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_principal" id="telefone_principal"
                                   class="form-control pula" value="{{ $fornecedor->entidade->telefone_principal }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_comercial"
                                   ...
                                   value="{{ $fornecedor->entidade->telefone_comercial }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_1" id="celular_1"
                                   class="form-control pula" value="{{ $fornecedor->entidade->celular_1 }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_2" id="celular_2"
                                   class="form-control pula" value="{{ $fornecedor->entidade->celular_2 }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="site" id="site"
                                   class="form-control pula" value="{{ $fornecedor->entidade->site }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email"
                                   class="form-control pula" value="{{ $fornecedor->entidade->email }}">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="cep" name="cep"
                                       ...
                                       value="{{ $fornecedor->entidade->endereco_principal->cep }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input id="logradouro" type="text" class="form-control pula"
                                       name="logradouro"
                                       value="{{ $fornecedor->entidade->endereco_principal->logradouro }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" id="numero" name="numero"
                                       class="form-control pula"
                                       value="{{ $fornecedor->entidade->endereco_principal->numero }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" id="complemento" name="complemento"
                                       class="form-control pula"
                                       value="{{ $fornecedor->entidade->endereco_principal->complemento }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="bairro" name="bairro"
                                       class="form-control pula"
                                       value="{{ $fornecedor->entidade->endereco_principal->bairro }}">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <modal-link tipo="button" css="btn btn-danger" nome="modal-deletar"
                                        titulo="Excluir"></modal-link>
                        </div>
                    </div>
                </div>
            </formulario>

...
@section('title', 'Inquilinos - Criar')
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="fa fa-plus"></i> Cadastrar Inquilino
        </li>
    </ol>
@stop
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Criar Inquilino</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <select name="cidade_id_principal" id="cidade_principal"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <select name="cidade_id_cobranca" id="cidade_cobranca"
                                                            class="form-control pula select2"

@extends('layouts.app')
@section('titulo', 'Inquilinos - Criar')
@section('conteudo')
    <pagina tamanho="10">
        <painel cor="panel-primary" titulo="Cadastrar inquilino">
            <div class="row">
                <div class="col-md-1">
            ...
            <formulario method="POST" action="{{ route('entidades.inquilinos.salvar') }}" token="{{ csrf_token() }}">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_comercial" id="telefone_comercial"
                                   class="form-control pula">
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="test"  id="numero" name="numero_principal" class="form-control pula">
                            </div>
                        </div>
                ...
                <painel titulo="Endereço cobrança" cor="panel-info" posicao="text-center">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="cep" class="control-label">CEP</label>

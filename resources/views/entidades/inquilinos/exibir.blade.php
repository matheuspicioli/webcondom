                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control" value="{{ $inquilino->entidade->cpf_cnpj }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control" value="{{ $inquilino->entidade->nome }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="apelido" class="control-label">Apelido</label>
                            <input type="text" name="apelido" id="apelido" class="form-control" value="{{ $inquilino->entidade->apelido }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="rg_ie" class="control-label">RGIE</label>
                            <input type="text" name="rg_ie" id="rg_ie" class="form-control" value="{{ $inquilino->entidade->rg_ie }}">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                            <label for="codigo" class="control-label">Código</label>
                            <input type="text" name="codigo" id="codigo" class="form-control" value="{{ $inquilino->codigo }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="fantasia" id="fantasia" class="form-control cnpj" value="{{ $inquilino->entidade->fantasia }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="inscricao_municipal" id="inscricao_municipal"
                                   class="form-control cnpj" value="{{ $inquilino->entidade->inscricao_municipal }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="ramo_atividade" id="ramo_atividade"
                                   class="form-control cnpj" value="{{ $inquilino->entidade->ramo_atividade }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_abertura" id="data_abertura"
                                   class="form-control cnpj" value="{{ $inquilino->entidade->data_abertura }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_mae" id="nome_mae" class="form-control cpf" value="{{ $inquilino->entidade->nome_mae }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="profissao" id="profissao" class="form-control cpf" value="{{ $inquilino->entidade->profissao }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_nascimento" id="data_nascimento"
                                   class="form-control cpf" value="{{ $inquilino->entidade->data_nascimento }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nacionalidade" id="nacionalidade"
                                   class="form-control cpf" value="{{ $inquilino->entidade->nacionalidade }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="empresa" id="empresa"
                                   class="form-control cpf" value="{{ $inquilino->entidade->empresa }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="inss" class="control-label cpf">INSS</label>
                            <input type="text" name="inss" id="inss" class="form-control cpf" value="{{ $inquilino->entidade->inss }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="dependentes" id="dependentes"
                                   class="form-control cpf" value="{{ $inquilino->entidade->dependentes }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_principal" id="telefone_principal"
                                   class="form-control" value="{{ $inquilino->entidade->telefone_principal }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_comercial"
                                   id="telefone_comercial" class="form-control" value="{{ $inquilino->entidade->telefone_comercial }}">
                            <span class="help-block">Este campo é opcional</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_1" id="celular_1"
                                   class="form-control" value="{{ $inquilino->entidade->celular_1 }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_2" id="celular_2"
                                   class="form-control" value="{{ $inquilino->entidade->celular_2 }}">
                            <span class="help-block">Este campo é opcional</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="site" id="site"
                                   class="form-control" value="{{ $inquilino->entidade->site }}">
                            <span class="help-block">Este campo é opcional</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email"
                                   class="form-control" value="{{ $inquilino->entidade->email }}">
                            <span class="help-block">Este campo é opcional</span>
                        </div>
                    </div>
                </div>

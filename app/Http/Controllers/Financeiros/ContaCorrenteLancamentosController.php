...
*/
    ...
    public function LancamentosPeriodo($dias, $conta_id)
    {
        ...
        $data_inicio_formatada = $this->lancamento->where('conta_corrente_id', $conta_id)->orderBy('data_lancamento', 'DESC')->first()->data_lancamento->subDay($dias)->format('Y-m-d');
    ...
    public function LancamentosAnteriores($dia_anterior, $conta_id)
    {
        ...
        $data_ultimo_formatada    = $dia_anterior->format('Y-m-d');
